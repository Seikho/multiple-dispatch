...
const fixtures: Array<MatchFixture> = [
  {
    ...
    assertions: [{ in: 'aa', out: 'aa' }, { in: 'ab', out: 'ab' }, { in: 'ba', out: 'ba' }, { in: 'bb', out: 'bb' }]
  },
  {
    name: 'too many arguments',
    params,
    handlers: baseHandler,
    assertions: [{ in: 'abc', out: Errors.InvalidTypeCount }]
  },
  {
    name: 'too few arguments',
    params,
    handlers: baseHandler,
    assertions: [{ in: 'a', out: Errors.InvalidTypeCount }]
  },
  {
    name: 'no match found',
    params,
    handlers: baseHandler,
    assertions: [{ in: 'cc', out: Errors.NoMatchError }]
  },
  {
    name: 'specific ambiguous call',
    params,
    handlers: [...baseHandler, make('a', 'a')],
    assertions: [{ in: 'aa', out: Errors.AmbiguousError }]
  },
  {
    name: 'non-specific ambiguous call',
    params,
    handlers: baseHandler,
    assertions: [{ in: 'ac', out: Errors.AmbiguousError }]
  }
]
